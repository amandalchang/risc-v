...
async def test_cpu(dut):
    ...
    for j in range(5):
        ...
        print(f"alu op: {dut.control.alu_op.value}")
        print(f"alu control: {dut.alu_control.value}")
        ...
        print(f"pc update: {dut.control.pc_update.value}")
        ...
        print(f"imem_data_out: {dut.imem_data_out.value}")
